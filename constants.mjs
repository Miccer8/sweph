const constants = {
  ...
  SE_AUNIT_TO_LIGHTYEAR: 1 / 63241.07708427,
  SE_AUNIT_TO_PARSEC: 1 / 206264.8062471,
  SE_JUL_CAL: 0,
  SE_GREG_CAL: 1,
  SE_ECL_NUT: -1,
  SE_SUN: 0,
  ...
  SE_AST_OFFSET: 10000,
  SE_VARUNA: export const SE_AST_OFFSET + 20000,
  SE_FICT_OFFSET: 40,
  SE_FICT_OFFSET_1: 39,
  SE_FICT_MAX: 999,
  SE_NFICT_ELEM: 15,
  SE_COMET_OFFSET: 1000,
  SE_NALL_NAT_POINTS: export const SE_NPLANETS + export const SE_NFICT_ELEM,
  SE_CUPIDO: 40,
  SE_HADES: 41,
  SE_ZEUS: 42,
  SE_KRONOS: 43,
  ...
  SEFLG_NOGDEFL: 512,
  SEFLG_NOABERR: 1024,
  SEFLG_ASTROMETRIC: export const SEFLG_NOABERR | export const SEFLG_NOGDEFL,
  SEFLG_EQUATORIAL: 2 * 1024,
  SEFLG_XYZ: 4 * 1024,
  SEFLG_RADIANS: 8 * 1024,
  SEFLG_BARYCTR: 16 * 1024,
  SEFLG_TOPOCTR: 32 * 1024,
  SEFLG_ORBEL_AA: export const SEFLG_TOPOCTR,
  SEFLG_TROPICAL: 0,
  SEFLG_SIDEREAL: 64 * 1024,
  SEFLG_ICRS: 128 * 1024,
  SEFLG_DPSIDEPS_1980: 256 * 1024,
  SEFLG_JPLHOR: export const SEFLG_DPSIDEPS_1980,
  SEFLG_JPLHOR_APPROX: 512 * 1024,
  SEFLG_CENTER_BODY: 1024 * 1024,
  SEFLG_TEST_PLMOON: 2 * 1024 * 1024 | export const SEFLG_J2000 | export const SEFLG_ICRS | export const SEFLG_HELCTR | export const SEFLG_TRUEPOS,
  SE_SIDBITS: 256,
  ...
  SEFLG_DEFAULTEPH: export const SEFLG_SWIEPH,
  SE_MAX_STNAME: 256,
  SE_ECL_CENTRAL: 1,
  SE_ECL_NONCENTRAL: 2,
  SE_ECL_TOTAL: 4,
  ...
  SE_ECL_HYBRID: 32,
  SE_ECL_PENUMBRAL: 64,
  SE_ECL_ALLTYPES_SOLAR: export const SE_ECL_CENTRAL | export const SE_ECL_NONCENTRAL | export const SE_ECL_TOTAL | export const SE_ECL_ANNULAR | export const SE_ECL_PARTIAL | export const SE_ECL_ANNULAR_TOTAL,
  SE_ECL_ALLTYPES_LUNAR: export const SE_ECL_TOTAL | export const SE_ECL_PARTIAL | export const SE_ECL_PENUMBRAL,
  SE_ECL_VISIBLE: 128,
  ...
  SE_BIT_HINDU_RISING: export const SE_BIT_DISC_CENTER | export const SE_BIT_NO_REFRACTION | export const SE_BIT_GEOCTR_NO_ECL_LAT,
  SE_ECL2HOR: 0,
  SE_EQU2HOR: 1,
  SE_HOR2ECL: 0,
  SE_HOR2EQU: 1,
  ...
  SE_FNAME_DFT: export const SE_FNAME_DE431,
  SE_FNAME_DFT2: export const SE_FNAME_DE406,
  ...
  SE_MORNING_FIRST: export const SE_HELIACAL_RISING,
  SE_EVENING_LAST: export const SE_HELIACAL_SETTING,
  SE_EVENING_FIRST: 3,
  SE_MORNING_LAST: 4,
  SE_ACRONYCHAL_RISING: 5,
  SE_ACRONYCHAL_SETTING: 6,
  SE_COSMICAL_SETTING: export const SE_ACRONYCHAL_SETTING,
  ...
  SE_HELFLAG_AVKIND: export const SE_HELFLAG_AVKIND_VR | export const SE_HELFLAG_AVKIND_PTO | export const SE_HELFLAG_AVKIND_MIN7 | export const SE_HELFLAG_AVKIND_MIN9,
  ...
  SE_TIDAL_DEFAULT: export const SE_TIDAL_DE431,
  SE_TIDAL_AUTOMATIC: 999999,
  SE_TIDAL_MOSEPH: export const SE_TIDAL_DE404,
  SE_TIDAL_SWIEPH: export const SE_TIDAL_DEFAULT,
  SE_TIDAL_JPLEPH: export const SE_TIDAL_DEFAULT,
  ...
  SEMOD_PREC_DEFAULT: export const SEMOD_PREC_VONDRAK_2011,
  SEMOD_PREC_DEFAULT_SHORT: export const SEMOD_PREC_VONDRAK_2011,
  SEMOD_NNUT: 5,
  ...
  SEMOD_NUT_WOOLARD: 5,
  SEMOD_NUT_DEFAULT: export const SEMOD_NUT_IAU_2000B,
  SEMOD_NSIDT: 4,
  SEMOD_SIDT_IAU_1976: 1,
  SEMOD_SIDT_IAU_2006: 2,
  SEMOD_SIDT_IERS_CONV_2010: 3,
  SEMOD_SIDT_LONGTERM: 4,
  SEMOD_SIDT_DEFAULT: export const SEMOD_SIDT_LONGTERM,
  SEMOD_NBIAS: 3,
  SEMOD_BIAS_NONE: 1,
  SEMOD_BIAS_IAU2000: 2,
  SEMOD_BIAS_IAU2006: 3,
  SEMOD_BIAS_DEFAULT: export const SEMOD_BIAS_IAU2006,
  SEMOD_NJPLHOR: 2,
  SEMOD_JPLHOR_LONG_AGREEMENT: 1,
  SEMOD_JPLHOR_DEFAULT: export const SEMOD_JPLHOR_LONG_AGREEMENT,
  SEMOD_NJPLHORA: 3,
  SEMOD_JPLHORA_1: 1,
  SEMOD_JPLHORA_2: 2,
  SEMOD_JPLHORA_3: 3,
  SEMOD_JPLHORA_DEFAULT: export const SEMOD_JPLHORA_3,
  SEMOD_NDELTAT: 5,
  ...
  SEMOD_DELTAT_DEFAULT: export const SEMOD_DELTAT_STEPHENSON_ETC_2016,
};
